$(document).ready(function () {
  ...
  $(".testimonial_slider").owlCarousel({
    ...
    items: 1,
    navText: [
      '<span class="iconify" data-icon="pepicons-pop:angle-left"></span>',
      '<span class="iconify" data-icon="pepicons-pop:angle-right"></span>',
    ],
    // autoplay:true,
    // autoplayTimeout:5000,
  });
  ...
  $(".has_dropdown a").on("click", function () {
    ...
    $(this)
      .parent()
      .toggleClass("active_link")
      .siblings()
      .removeClass("active_link");
    $(this)
      .find(".iconify")
      .toggleClass("rotate_svg")
      .parent()
      .parent()
      .siblings()
      .find(".iconify")
      .removeClass("rotate_svg");
  });
  ...
  $(".history_timeline_area .history_tab_links").owlCarousel({
    ...
    dots: false,
    navText: [
      '<span class="iconify" data-icon="prime:angle-left"></span>',
      '<span class="iconify" data-icon="prime:angle-right"></span>',
    ],
    responsive: {
      0: {
